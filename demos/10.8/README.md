...
- Replace or augment centroid-field rotation with a graph/allowed-space-aware rotation heuristic, since local egress and surrounding routable space dominate machine orientation quality.
